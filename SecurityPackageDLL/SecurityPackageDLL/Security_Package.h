...
public:
	...
	virtual const string Decipher(string&, int&, int **)=0;
	virtual const string Decipher(string&, int&)=0;
	virtual const string Decipher_Based_on_Previous_Ciphering(string&) { return "";}
protected:
